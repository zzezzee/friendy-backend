...
@Service
@Transactional
public class AcceptInvitationNotificationService {
    private final EmitterRepository emitterRepository;
    private final UserRepository userRepository;
    private final NotificationRepository notificationRepository;

    public AcceptInvitationNotificationService(EmitterRepository emitterRepository, UserRepository userRepository,
    ...
    public void sendNotification(Username sender, Username receiver) throws JsonProcessingException {
        InvitationNotification InvitationNotification = new InvitationNotification(
                receiver,
                sender,
                new Type("AcceptInvitation")
        );

        InvitationNotification notification = notificationRepository.save(InvitationNotification);

        Map<Username, SseEmitter> sseEmitters = emitterRepository.findByUsername(sender);
